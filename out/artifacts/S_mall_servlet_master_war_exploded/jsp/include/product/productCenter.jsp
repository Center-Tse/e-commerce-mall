    ...
    <div class="detail">
        ...
        <div class="product-num">
            ...
            <div class="quantity-input">
                <button class="decrease-quantity" id="decrease-quantity">-</button>
                <input type="text" class="input" value="1" id="buy-number">
                <button class="increase-quantity" id="increase-quantity">+</button>
            </div>
        ...
        <div class="buy">
            ...
            <button class="cart-button" id="cart-button"><span class="glyphicon glyphicon-shopping-cart"></span>加入购物车</button>
        </div>
        <div class="service">
